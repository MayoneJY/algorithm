...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //     System.out.println(Arrays.toString(charMap[i]));
        // }
        createBridge();
    
        // for(int i = 0; i < bridge.size(); i++){
        //     System.out.println(Arrays.toString(bridge.get(i)));
        // }

        combination(0, new ArrayList<Integer>());

        // for(int i = 0; i < bridgeChar.size(); i++){
        //     System.out.println(bridgeChar.get(i));
        // }
    ...
    public static void run(ArrayList<Integer> c){
        ...
        if(!temp){
            ...
            // for(int i = 0; i < c.size(); i++){
            //     System.out.println(Arrays.toString(bridge.get(c.get(i))));
            // }
            // System.out.println("===============");
