...
public class Main {
    ...
    // public static boolean find(ArrayList<Integer> com){

    //     boolean[] temp = new boolean[com.size()];
    //     for(int i = 0; i < com.size(); i++){
    //         int[] map = nodeMap[com.get(i)];
    ...
    public static void run(ArrayList<Integer> com){
        ...
        if((!check1 || com.size() == 1) && (!check2 || com2.size() == 1)){
            ...
            // System.out.println(Arrays.toString(com2.toArray()));
            // System.out.println("-------");
            int sum1 = 0;
            int sum2 = 0;
            for(int i = 0; i < com.size(); i++){
